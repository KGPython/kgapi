 ...
 * then the themed version for a view file `@app/views/member/index.php` will be
 * `@app/themes/basic/member/index.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/member/index.php` or
 * `@app/themes/basic/member/index.php`. The former has precedence over the latter if both files exist.
 *
