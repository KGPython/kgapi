...
class BaseUrl
{
     ...
     *
     * ```php
     * // generates: /index.php?r=member/index&param1=value1&param2=value2
     ...
     *
     * ```php
     * // generates: /index.php?r=member/index&param1=value1#name
     * ['member/index', 'param1' => 'value1', '#' => 'name']
     * ```
     *
     * A route may be either absolute or relative. An absolute route has a leading slash (e.g. `/member/index`),
     * while a relative route has none (e.g. `member/index` or `index`). A relative route will be converted
     ...
     * - If the route has no leading slash (e.g. `member/index`), it is considered to be a route relative
     ...
     *
     * ```php
     * // /index.php?r=member%2Findex
     * echo Url::toRoute('member/index');
     *
     * // /index.php?r=member%2Findex&src=ref1#name
     * echo Url::toRoute(['member/index', 'src' => 'ref1', '#' => 'name']);
     *
     * // http://www.example.com/index.php?r=member%2Findex
     * echo Url::toRoute('member/index', true);
     *
     * // https://www.example.com/index.php?r=member%2Findex
     * echo Url::toRoute('member/index', 'https');
     *
     * // /index.php?r=post%2Findex     assume the alias "@posts" is defined as "post/index"
     * echo Url::toRoute('@posts');
     * ```
     *
     * @param string|array $route use a string to represent a route (e.g. `index`, `member/index`),
     ...
     *   `['member/index']`, `['post/index', 'page' => 2]`. Please refer to [[toRoute()]] for more details
     ...
     * ```php
     * // /index.php?r=member%2Findex
     * echo Url::to(['member/index']);
     *
     * // /index.php?r=member%2Findex&src=ref1#name
     * echo Url::to(['member/index', 'src' => 'ref1', '#' => 'name']);
     *
     * // /index.php?r=post%2Findex     assume the alias "@posts" is defined as "/post/index"
     * echo Url::to(['@posts']);
     *
